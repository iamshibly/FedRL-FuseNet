...
```
    ...
    ======================================================================================================================
    RACE-FELCM PREPROCESSING-XAI PLOTS ONLY
    DEVICE: cuda
    ======================================================================================================================
    ...
    DS1 root: /kaggle/input/pmram-bangladeshi-brain-cancer-mri-dataset/PMRAM Bangladeshi Brain Cancer - MRI Dataset/PMRAM Bangladeshi Brain Cancer - MRI Dataset/Raw Data/Raw
    DS2 root: /kaggle/input/preprocessed-brain-mri-scans-for-tumors-detection/preprocessed_brain_mri_dataset
    DS1 selected samples: 4
    DS2 selected samples: 4
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_overview_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_1.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_overview_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_3.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_texture_denoising_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_5.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_texture_denoising_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_7.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_local_contrast_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_9.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_local_contrast_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_11.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_structure_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_13.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_structure_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_15.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_intensity_remap_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_17.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_intensity_remap_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_19.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_summary_xai_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_21.png)
    


    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_summary_xai_RACE_FELCM.png



    
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_0_23.png)
    


    
    ======================================================================================================================
    DONE: RACE-FELCM PREPROCESSING-XAI FIGURES GENERATED
    ======================================================================================================================
    Figure families            : 6
    Datasets                   : 2
    Saved figure files total   : 12
    Rows per dataset           : DS1=4, DS2=4
    Columns per figure         : 5
    Total subplot images       : 240
    Output directory           : /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS
    ======================================================================================================================
...
```
    ...
    DEVICE: cpu
    ======================================================================================================================
    Downloading to /root/.cache/kagglehub/datasets/orvile/pmram-bangladeshi-brain-cancer-mri-dataset/2.archive...


    100%|██████████| 161M/161M [00:00<00:00, 261MB/s]
    ...
    Downloading to /root/.cache/kagglehub/datasets/yassinebazgour/preprocessed-brain-mri-scans-for-tumors-detection/1.archive...
    ...
    DS1 root: /root/.cache/kagglehub/datasets/orvile/pmram-bangladeshi-brain-cancer-mri-dataset/versions/2/PMRAM Bangladeshi Brain Cancer - MRI Dataset/PMRAM Bangladeshi Brain Cancer - MRI Dataset/Raw Data/Raw
    DS2 root: /root/.cache/kagglehub/datasets/yassinebazgour/preprocessed-brain-mri-scans-for-tumors-detection/versions/1/preprocessed_brain_mri_dataset
    DS1 selected samples: 4
    DS2 selected samples: 4
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_overview_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_9.png)
    


    Dataset-1 — Overview Panel
    Caption: Overview Panel: Raw MRI is compared with the final RACE-FELCM output, the absolute residual magnitude, signed intensity change, and the composite preprocessing-response map.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_overview_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_11.png)
    


    Dataset-2 — Overview Panel
    Caption: Overview Panel: Raw MRI is compared with the final RACE-FELCM output, the absolute residual magnitude, signed intensity change, and the composite preprocessing-response map.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_texture_denoising_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_13.png)
    


    Dataset-1 — Texture / Denoising Panel
    Caption: Texture / Denoising Panel: This figure visualizes how RACE-FELCM estimates texture, suppresses flat noisy regions, and forms the denoised branch used before later enhancement.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_texture_denoising_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_15.png)
    


    Dataset-2 — Texture / Denoising Panel
    Caption: Texture / Denoising Panel: This figure visualizes how RACE-FELCM estimates texture, suppresses flat noisy regions, and forms the denoised branch used before later enhancement.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_local_contrast_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_17.png)
    


    Dataset-1 — Local Contrast Panel
    Caption: Local Contrast Panel: This figure shows the local mean, local standard deviation, normalized local deviation, and the contrast field that drives fuzzy local contrast enhancement.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_local_contrast_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_19.png)
    


    Dataset-2 — Local Contrast Panel
    Caption: Local Contrast Panel: This figure shows the local mean, local standard deviation, normalized local deviation, and the contrast field that drives fuzzy local contrast enhancement.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_structure_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_21.png)
    


    Dataset-1 — Structure Enhancement Panel
    Caption: Structure Enhancement Panel: This figure visualizes edge strength, Laplacian response, coherence weighting, and the final structure-gain effect used for edge-preserving enhancement.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_structure_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_23.png)
    


    Dataset-2 — Structure Enhancement Panel
    Caption: Structure Enhancement Panel: This figure visualizes edge strength, Laplacian response, coherence weighting, and the final structure-gain effect used for edge-preserving enhancement.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_intensity_remap_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_25.png)
    


    Dataset-1 — Intensity Remapping Panel
    Caption: Intensity Remapping Panel: This figure shows robust z-clipping, power-law remapping, pre-normalized enhancement response, and normalized enhanced intensity before final blending.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_intensity_remap_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_27.png)
    


    Dataset-2 — Intensity Remapping Panel
    Caption: Intensity Remapping Panel: This figure shows robust z-clipping, power-law remapping, pre-normalized enhancement response, and normalized enhanced intensity before final blending.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS1_summary_xai_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_29.png)
    


    Dataset-1 — Summary XAI Panel
    Caption: Summary XAI Panel: This figure overlays the strongest preprocessing responses, highlighting where RACE-FELCM emphasizes contrast, edges, and the combined enhancement behavior.
    ----------------------------------------------------------------------------------------------------------------------
    Saved: /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS/DS2_summary_xai_RACE_FELCM.png
...
![png](08_8_RACE_XAI_files/08_8_RACE_XAI_1_31.png)
    


    Dataset-2 — Summary XAI Panel
    Caption: Summary XAI Panel: This figure overlays the strongest preprocessing responses, highlighting where RACE-FELCM emphasizes contrast, edges, and the combined enhancement behavior.
    ----------------------------------------------------------------------------------------------------------------------
    ...
    Saved figure files total : 12
    Rows per dataset         : DS1=4, DS2=4
    Columns per figure       : 6
    Subplots per figure      : 24
    Total subplot images     : 288
    Output directory         : /content/RACE_FELCM_PREPROCESSING_XAI_OUTPUTS
    ======================================================================================================================
